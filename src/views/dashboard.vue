                  ...
                  <b-card>
                    <b-row>
                        <b-col sm="12" md="12" lg="12">
                           ...
                           <b-button size="md" class="mr-1 my-1" @click="SelectSocial('television')" :variant="filter.socialid === 'television' ? 'primary' : 'outline-primary'"> <feather-icon size="28" style="margin-top:8px;margin-bottom:8px" icon="TvIcon"></feather-icon> </b-button>
                           <b-button size="md" class="mr-1 my-1" @click="SelectSocial('radio')" :variant="filter.socialid === 'radio' ? 'primary' : 'outline-primary'"> <feather-icon size="28" style="margin-top:8px;margin-bottom:8px" icon="RadioIcon"></feather-icon> </b-button>
                           <b-button size="md" class="mr-1 my-1" @click="SelectSocial('gazeta')" :variant="filter.socialid === 'gazeta' ? 'primary' : 'outline-primary'"> <feather-icon size="28" style="margin-top:8px;margin-bottom:8px" icon="BookIcon"></feather-icon> </b-button>
                           <b-button size="md" class="mr-1 my-1" @click="SelectSocial('jurnal')" :variant="filter.socialid === 'jurnal' ? 'primary' : 'outline-primary'"> <feather-icon size="28" style="margin-top:8px;margin-bottom:8px" icon="BookOpenIcon"></feather-icon> </b-button>
                        <b-button size="md" class="mr-1 my-1" @click="SelectSocial('other')" :variant="filter.socialid === 'other' ? 'primary' : 'outline-primary'" > <feather-icon size="28" style="margin-top:8px;margin-bottom:8px" icon="MoreHorizontalIcon"></feather-icon> </b-button>
