...
const OrganizationService = {
  GetList(
    ...
    return ApiService.get(
      `/organization/page=${page}&limit=${limit}&oblast=${oblast ||
        null}&category=${category || null}&specialization=${specialization ||
        null}&organ=${organ || null}&isconnect=${isconnect ||
        null}&lang=${lang}&found=${found || null}/`
    );
  },
  GetOblastList(lang) {
  ...
  OrganizationGetOblastID(
    ...
    // }
    return ApiService.get(
      `/OrganizationGetOblastID/oblast=${oblast}&category=${category}&specialization=${specialization}&isconnect=${isconnect}&satsial=${satsial}&lang=${lang}/`
    );
  },
  Specialization(lang) {
